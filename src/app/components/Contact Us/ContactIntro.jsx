...
//       {/* Content and image */}
//       <div className="flex">
//         <div className="w-[60%] bg-amber-300">
//             {/* content-para*/}
//             <div className="mt-2 w-[80%]">
//                 <p className="uppercase text-xs max-w-md text-gray-500">
...
//                     </div>
//                     <div>
//                         <div className="uppercase text-xs text-[#A27D2A] mb-1">PHONE</div>
...
//                     </div>
//                     <div>
//                         <div className="uppercase text-xs text-[#A27D2A] mb-1">EMAIL</div>
...
//             {/*Question section*/}
//             <div className="mt-20">
//                 <h2 className="text-4xl ">Got Style Questions?</h2>
//                 <h2 className="text-4xl mb-6">Drop Us a Hello!</h2>
...
//                         <input type="email" className="w-full bg-gray-100 p-2 rounded" />
//                     </div>
//                     <div>
//                         <label className="block text-xs uppercase mb-1">Phone Number</label>
//                         <input type="tel" className="w-full bg-gray-100 p-2 rounded" />
//                     </div>
//                     <div>
//                         <label className="block text-xs uppercase mb-1">Message</label>
//                         <textarea className="w-full bg-gray-100 p-2 rounded h-24"></textarea>
//                     </div>
//                     <button className="bg-[#AF803C] text-white px-6 py-3  text-sm rounded cursor-pointer  whitespace-nowrap">Send</button>
//                 </form>
//             </div>
//         </div>
        ...
        <div className="w-[60%]  relative z-10">
          ...
          <div className="mt-20 pb-16">
            ...
            <form className="space-y-4 max-w-md mt-20">
              <div>
                <label className="block text-xs uppercase mb-1">Name</label>
                <input type="text" className="w-full bg-gray-100  border-2 border-gray-200 p-2 rounded" />
              </div>
              <div>
                <label className="block text-xs uppercase mb-1">Email</label>
                <input type="email" className="w-full bg-gray-100 border-2 border-gray-200 p-2 rounded" />
              </div>
              <div>
                <label className="block text-xs uppercase mb-1">Phone Number</label>
                <input type="tel" className="w-full bg-gray-100 border-2 border-gray-200 p-2 rounded" />
              </div>
              <div>
                <label className="block text-xs uppercase mb-1">Message</label>
                <textarea className="w-full bg-gray-100 p-2 border-2 border-gray-200 rounded h-24"></textarea>
              </div>
              <button className="bg-[#AF803C] text-white px-8 py-3 text-sm rounded cursor-pointer whitespace-nowrap">Send</button>
            </form>
